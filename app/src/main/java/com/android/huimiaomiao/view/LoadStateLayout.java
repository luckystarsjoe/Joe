 ...
 * 切换加载状态辅助view
 */
public class LoadStateLayout extends LinearLayout implements
    ...
    private void init() {
        View view = View.inflate(context, R.layout.load_state, null);
    ...
    public void setErrorType(int i) {
        ...
        case NETWORK_ERROR:
            ...
            // img.setBackgroundDrawable(SkinsUtil.getDrawable(context,"state_icon_load_failed"));
            if (NetUtils.isConnected(context)) {
                tv.setText(R.string.load_error_click_to_refresh);
                img.setBackgroundResource(R.drawable.state_icon_load_failed);
            } else {
                tv.setText(R.string.net_error_click_to_refresh);
                img.setBackgroundResource(R.drawable.state_icon_network);
            }
        ...
        case NODATA:
            mErrorState = NODATA;
            // img.setBackgroundDrawable(SkinsUtil.getDrawable(context,"state_icon_empty"));
            img.setBackgroundResource(R.drawable.state_icon_empty);
            img.setVisibility(View.VISIBLE);
